...
locations are introduced. I have cleaned the names of each variable,
selected major variables we want to look deeper, and changed the
character input of entry into logical. I think the dataset is not yet
